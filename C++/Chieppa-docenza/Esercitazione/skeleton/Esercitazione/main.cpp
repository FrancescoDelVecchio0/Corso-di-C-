...
int main() {
    ...
    // Aggiungi alcuni item iniziali
    [[maybe_unused]] const auto added_health_potion =
        inventory.add_item(rpg::inventory::create_common_item("health_potion"));
    [[maybe_unused]] const auto added_iron_sword =
        inventory.add_item(rpg::inventory::create_common_item("iron_sword"));
